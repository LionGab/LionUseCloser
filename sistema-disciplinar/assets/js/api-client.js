...
// Auto-redirect se não autenticado (exceto na página de login)
if (!window.location.pathname.includes('login.html') && !window.apiClient.isAuthenticated()) {
  // Ajuste para funcionar em /sistema-disciplinar
  const basePath = window.location.pathname.includes('/sistema-disciplinar') 
    ? '/sistema-disciplinar/pages/login.html' 
    : '/pages/login.html';
